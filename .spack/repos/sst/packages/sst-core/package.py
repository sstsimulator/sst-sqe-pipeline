...
# (https://github.com/spack/spack/blob/develop/COPYRIGHT) file for details.
#
...
class SstCore(AutotoolsPackage):
    ...
    variant('zoltan', default=False, description='Use zoltan')
    ...
    def configure_args(self):
        ...
        if '+zoltan' in spec:
            args.append('--with-zoltan=%s' % spec['zoltan'].prefix)
